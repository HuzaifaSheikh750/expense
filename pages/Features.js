        ...
        <div className="container" style={{marginTop:"150px"}}>
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 ms-auto" data-aos="fade-left">
              ...
              It radically decreases the time needed to capture receipts, make expense reports, configure expense policies, 
              and get them approved using several workflow configuration option
              </p>
            </div>
            {/* End .col-6 */}
          </div>
