        ...
        >
          <article className="blog-meta-three mt-40 wow fadeInUp">
            <figure className="post-img m0">
              <Link href="https://www.kaispe.com/resources/blogs/" target="_blank" className="w-100 d-block">
                <Image
                  width={410}
                  height={300}
                  src={post.imageSrc}
            ...
            <div className="post-data mt-40 truncate"  >
              ...
              <Link href="https://www.kaispe.com/resources/blogs/" target="_blank" className="mt-5 mb-35 lg-mb-20" >
              ...
              <div>
                <Link
                  href="https://www.kaispe.com/resources/blogs/" target="_blank"
