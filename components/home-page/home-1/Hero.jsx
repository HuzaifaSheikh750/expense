  ...
  return (
    ...
    <div className="hero-banner-ten position-relative zn2">
      ...
      <div className="container" style={{marginBottom:"0px", marginTop:"60px"}}   onClick={() => setOpen(true)} role="button">
        ...
        <div className="row">
          <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 text-center maintitle" data-aos="fade-up" style={{marginLeft:"-20px"}}>
            <h3 className="hero-heading fw-500 tx-dark  expenseheading" style={{fontSize:"60px", textAlign:"start", color:"white"}} >
            Keep Your <span style={{color:"#09A6F3"}}> Expenses  </span>Organized
            </h3>
            <p style={{textAlign:"start", marginTop:"40px",  color:"white"}} className="expensepara">KAISPE Expense Report app is a software application that helps businesses manage and track their travel and other expenses more efficiently. <br /> It is designed to simplify the process of capturing, submitting, and approving
